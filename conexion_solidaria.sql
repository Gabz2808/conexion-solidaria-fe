...
ALTER TABLE IF EXISTS public.miembrosgrupo
    ADD CONSTRAINT miembrosgrupo_idgrupo_fkey FOREIGN KEY (idgrupo)
...
ALTER TABLE IF EXISTS public.miembrosgrupo
    ADD CONSTRAINT miembrosgrupo_idusuario_fkey FOREIGN KEY (idusuario)
    REFERENCES public.usuario (idusuario) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.notificaciones
    ADD CONSTRAINT notificaciones_idusuario_fkey FOREIGN KEY (idusuario)
    REFERENCES public.usuario (idusuario) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.posts
    ADD CONSTRAINT posts_Idusuario_fkey FOREIGN KEY (Idusuario)
    REFERENCES public.usuario (idusuario) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.producto
    ADD CONSTRAINT producto_idusuario_fkey FOREIGN KEY (idusuario)
    REFERENCES public.usuario (idusuario) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;


ALTER TABLE IF EXISTS public.productoguardado
    ADD CONSTRAINT productoguardado_idusuario_fkey FOREIGN KEY (idusuario)
    REFERENCES public.usuario (idusuario) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.productoguardado
    ADD CONSTRAINT productoguardado_productoid_fkey FOREIGN KEY (productoid)
